...
import { CreateClientes, UpdateClientes } from "@/interfaces/Clientes"; // Importa los tipos para Clientes
import { Clientes } from "@prisma/client"; // Importa el tipo Cliente
