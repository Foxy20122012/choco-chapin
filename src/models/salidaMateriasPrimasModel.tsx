...
export type SalidasMateriasPrimasRow = {
  ...
  codigo_materia_prima: string | null; // Agregado el campo codigo_materia_prima
};
...
export const transformSalidasMateriasPrimasToRows = (
  ...
  return salidasMateriasPrimas.map((salida) => ({
    ...
    codigo_materia_prima: salida.codigo_materia_prima || null, // Mapeo del campo codigo_materia_prima
  }));
};
...
export const salidasMateriasPrimasColumns: Record<SalidasMateriasPrimasModel, string> = {
  ...
  codigo_materia_prima: "Código de Materia Prima", // Mapeo del campo codigo_materia_prima
};
