  ...
  return (
    ...
    >
      <input
        ...
        autoFocus
        placeholder="Title"
        className="border border-black w-full px-4 py-2 text-black bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 my-2"
      ...
      <textarea
        name="title"
        placeholder="Content"
        className="w-full px-4 py-2 text-black bg-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 my-2 border border-black"
