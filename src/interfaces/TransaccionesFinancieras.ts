...
export type CreateTransaccionesFinancieras = Omit<TransaccionesFinancieras, "id" | "fecha_transaccion">;
...
export type UpdateTransaccionesFinancieras = Partial<CreateTransaccionesFinancieras>;
